...
namespace PreCalculate
{
    ...
    static inline Bitboard evaluateMaskedOccupancy(int occupancy_index, Bitboard attack_mask)
    {
    ...
    static inline Bitboard evaluatePawnAttackMask(int color, int source_square)
    {
    ...
    static inline Bitboard evaluateKnightAttackMask(int source_square)
    {
        Bitboard bitboard = EMPTY_BOARD;
        Bitboard attack_mask = EMPTY_BOARD;
        BitboardUtils::setBit(bitboard, source_square);
    ...
    static inline Bitboard evaluateKingAttackMask(int source_square)
    {
        Bitboard bitboard = EMPTY_BOARD;
        Bitboard attack_mask = EMPTY_BOARD;
        BitboardUtils::setBit(bitboard, source_square);
    ...
    static inline Bitboard evaluateRawBishopAttackMask(int source_square)
    {
        Bitboard attack_mask = EMPTY_BOARD;
        int rank, file;
    ...
    static inline Bitboard evaluateBishopAttackMask(int source_square, Bitboard occupancy)
    {
        Bitboard attack_mask = EMPTY_BOARD;
        int rank, file;
        int target_rank = source_square / DIMENSION;
    ...
    static inline Bitboard evaluateRawRookAttackMask(int source_square)
    {
        Bitboard attack_mask = EMPTY_BOARD;
        int rank, file;
        int target_rank = source_square / DIMENSION;
    ...
    static inline Bitboard evaluateRookAttackMask(int source_square, Bitboard occupancy)
    {
        Bitboard attack_mask = EMPTY_BOARD;
        int rank, file;
        int target_rank = source_square / DIMENSION;
