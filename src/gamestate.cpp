...
U64 GameState::get_piece_occupancy(int piece) { return piece_occupancies[piece]; }
U64 GameState::get_color_occupancy(int color) { return color_occupancies[color]; }
std::vector<int> GameState::get_moves() { return moves; }
int GameState::get_move(int i) { return moves[i]; }
void GameState::push_move(int move) { moves.push_back(move); }
